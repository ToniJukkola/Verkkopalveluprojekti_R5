...
export default function Product({ url, addToCart, amount, setAmount }) {
    ...
    <main className="container">
      <div className='grid_container'>
        ...
        <div className="text-center">
          <button className="btn btn-accent" onClick={e => addToCart(product, amount)}><i className="bi bi-bag-fill"></i> Lisää ostoskoriin</button>
